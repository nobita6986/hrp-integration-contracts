...
1. **Gap**: Target struct for read query does not require laborProfileVersion. Existing generic schemas (`TalentTargetRefSchema` and `ContextQueryRequestSchema`) currently require or lack specificity for this boundary.
