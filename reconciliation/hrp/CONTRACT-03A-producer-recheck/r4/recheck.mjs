...
const sha = '272e883ef48c552054849905d7b75695b7ac4d8f';
...
console.log('DIAGNOSTIC_ONLY legacy implementation-shaped input (excluded from conformance counts): ' + JSON.stringify(validate()));
...
check('F01 query accepted actor cannot be stripped/rejected by claims schema',true,()=>validate({...implClaims,actor},{...implHeader,typ:'hrp-crm-service+jwt'},{query:true}));
