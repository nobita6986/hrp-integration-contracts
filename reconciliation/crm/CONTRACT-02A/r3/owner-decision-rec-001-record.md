...
Bundle: reconciliation/crm/CONTRACT-02A/r3/
...
Per supplement §C: HRP proposes canonical authority; shared decision has NOT been bilaterally accepted. The correct fact (HRP owns canonical PlacementCase authority) is stated first; the supplement caveat is a separate, narrower note about interface mapping, not a co-equal conclusion about ownership.

## 4. What this record distinguishes (CR-7, CR-8 in r2)

This acknowledgement distinguishes four separate things:

(a) Owner decision: REC-001 domain authority is APPROVED. This is a governance record from Owner.
(b) Evidence bundle ACK: The CRM CONTRACT-01 r1 evidence bundle (commit 25fc8b1) was acknowledged with INTEGRITY_ONLY verification. This is a technical integrity check, not business acceptance.
...
- REC-002 (S2S Auth): OPEN/PROPOSED. Owner note: OPEN/PROPOSED is not sufficient to open a real path; auth design must be accepted, implementation evidence gathered, and slice readiness gate cleared.
...
- Does not self-conclude where REC-001-OPS union is evaluated.
