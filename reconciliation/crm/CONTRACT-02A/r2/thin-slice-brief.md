...
packages/contracts/src/enums.ts:
  ...
  Line 140: CURRENT_RELATIONSHIP_READONLY = true (marker flag)
  Line 150: NextActionStatusSchema = z.enum([OPEN, DONE, CANCELLED])

packages/contracts/src/commands/profile.ts:
  Line 93: ProfilePatchSchema = z.record(z.string(), PatchFieldSchema) with whitelist validation
  Line 65: PROFILE_PATCH_WHITELIST = Object.freeze([fullName, phone, dob, citizenAddress, contactAddress, gender, emergencyContact])
  Line 94: ProfilePatch type alias = z.infer<typeof ProfilePatchSchema>
  Line 99: UpdateLaborProfileInputSchema = z.object({ organizationId, laborProfileId, expectedVersion, patch: ProfilePatchSchema, fillMissingOnly: z.literal(true), evidenceRefs.optional(), submissionRevisionId.optional() })
...
packages/contracts/src/commands/queries.ts:
  ...
  Line 230: ContextPanelAvailabilitySchema = z.object({ schemaVersion, availability: AvailabilitySchema, availableFromDate.optional(), aggregateVersion, contactabilityVersion.optional() })
  ...
  Line 100: QueryScopeSchema = z.object({ schemaVersion, organizationId, actor, asOfVersion.optional(), provider.optional(), connectionId.optional() })
  Line 68: CursorPaginationInputSchema = z.object({ cursor.optional(), pageSize.optional().default(20) })
  Line 361: ReadOnlyIdentityPreviewRequestSchema = z.object({ schemaVersion, scope: QueryScopeSchema }) (read-only preview; does NOT mutate)
...
- P9/H.09 (gateway that + canonical readiness gate) is the readiness gate that authorizes switching from mock to HRP real.
